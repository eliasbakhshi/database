...
--
-- Temporary table structure for view `v_last_3_larare`
--

DROP TABLE IF EXISTS `v_last_3_larare`;
/*!50001 DROP VIEW IF EXISTS `v_last_3_larare`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_last_3_larare` AS SELECT
 1 AS `akronym`,
  1 AS `Ålder` */;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `v_last_3_larare`
--
